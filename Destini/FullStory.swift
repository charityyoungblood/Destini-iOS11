...
class FullStory {
        ...
        // allAnswers = [answer1, answer2, answer3, answer4, answer5, answer6, answer7]
        ...
        let story7 = "As you begin to drive, the stranger starts talking about his relationship with his mother. He gets angrier and angrier by the minute. He asks you to open the glovebox. Inside you find a bloody knife, two severed fingers, and a cassette tape of Elton John. He reaches for the glove box."
        
        let story6 = "Well, at least now I don't have to find a place do dump your body!"
        ...
        let answer1 = "I\'ll hop in. Thanks for the help!" // if answer 1, go to story 7
        let answer2 = "Better ask him if he\'s a murderer first."
        
        let answer3 = "At least he\'s honest. I\'ll climb in."
        let answer4 = "No way, I'm running for the hills!" // if answer 4, go to story 3
    
        let answer5 = "Ok, I do have a sense of humor."
        let answer6 = "I love Elton John! Here's the cassette tape." // if answer 6, go to story 4
        let answer7 = "It\'s him or me! You take the knife and stab him."
        let answer8 = "I'll get in, but I'm keeping a close eye on you."
